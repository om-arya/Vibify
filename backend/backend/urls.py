...
urlpatterns = [
    ...
    path('users/get_user_by_username/', views.get_user_by_username, name='users/get_user_by_username/'),
    path('users/get_user_by_email/', views.get_user_by_email, name='users/get_user_by_email'),
